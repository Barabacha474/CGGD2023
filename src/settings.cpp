...
std::shared_ptr<settings> cg::settings::parse_settings(int argc, char** argv)
{
	...
	add_options("height", "Render target height", cxxopts::value<unsigned>()->default_value("1600"));
	add_options("width", "Render target width", cxxopts::value<unsigned>()->default_value("2560"));
